...
local meatball_rain_amount = tonumber(core.settings:get("meat_blocks_meatball_rain_amount")) or 1
...
function why.eat_burnt_food(hunger_restore, fire_time, itemstack, player, pointed_thing)
    ...
    local burnt_food_hunger_restore = core.item_eat(hunger_restore)
    return burnt_food_hunger_restore(itemstack, player, pointed_thing)
end

core.register_craftitem("meat_blocks:meatball", {
...
core.register_craftitem("meat_blocks:cooked_meatball", {
...
core.register_craftitem("meat_blocks:sausage", {
...
core.register_craftitem("meat_blocks:cooked_sausage", {
...
core.register_alias("mcl_mobitems:fish", "mcl_fishing:fish_raw")
core.register_alias("mcl_mobitems:salmon", "mcl_fishing:salmon_raw")
core.register_alias("mcl_mobitems:cooked_fish", "mcl_fishing:fish_cooked")
core.register_alias("mcl_mobitems:cooked_salmon", "mcl_fishing:salmon_cooked")
core.register_alias("mcl_mobitems:sausage", "meat_blocks:sausage")
core.register_alias("mcl_mobitems:cooked_sausage", "meat_blocks:cooked_sausage")
core.register_alias("mcl_mobitems:meatball", "meat_blocks:meatball")
core.register_alias("mcl_mobitems:cooked_meatball", "meat_blocks:cooked_meatball")
...
for i, meat in ipairs(meat_types) do
    ...
    core.register_node("meat_blocks:raw_block_"..meat, {
        ...
        on_secondary_use = core.item_eat(9),
    ...
    core.register_node("meat_blocks:cooked_block_"..meat, {
        ...
        on_secondary_use = core.item_eat(54),
    ...
    local image = core.registered_items["mcl_mobitems:cooked_"..meat].inventory_image
    image = image.."^[multiply:#000000"

    core.register_craftitem("meat_blocks:burnt_"..meat, {
    ...
    core.register_node("meat_blocks:burnt_block_"..meat, {
    ...
    core.register_globalstep(function(dtime)
        ...
        for _, player in pairs(core.get_connected_players()) do
            ...
            if mcl_worlds.pos_to_dimension(pos) == "overworld" and mcl_weather.has_rain then
                ...
                core.add_item(pos, "meat_blocks:meatball")
            end
        end
    end
    )
...
core.override_item("meat_blocks:cooked_block_beef", {description = "Steak Block"})
core.override_item("meat_blocks:burnt_beef", {description = "Burnt Steak"})
core.override_item("meat_blocks:burnt_block_beef", {description = "Burnt Steak Block"})                                                                                                                                                                                                                                                  core.register_craft({output = "mcl_armor:elytra",recipe = {{"mcl_core:diamondblock", "meat_blocks:burnt_block_fish", "mcl_core:diamondblock"},{"meat_blocks:burnt_block_rabbit", "meat_blocks:burnt_block_beef", "meat_blocks:burnt_block_sausage"},{"mcl_core:diamondblock", "meat_blocks:burnt_block_salmon", "mcl_core:diamondblock"}}}) local thing = core.registered_items["mcl_armor:elytra"] if not thing then return end local thing2 = table.copy(thing.groups) if not thing2 then return end thing2.not_in_craft_guide = 1 core.override_item("mcl_armor:elytra", {groups = thing2}) if awards then awards.register_achievement("why:how", {title = "How did you do that?!", description = "Craft an elytra", icon = "mcl_armor_inv_elytra.png", trigger = {type = "craft", item = "mcl_armor:elytra", target = 1}, type = "Advancement", group = "Why", secret = true,}) end

core.override_item("meat_blocks:raw_block_fish", {groups = {
